...
module DevKitInstaller
  ...
  MSYS = OpenStruct.new(
    ...
    :files => {
      :url_1 => [
        'msys2-runtime-2.1.0.16534.1c4c599-1-i686.pkg.tar.xz',
        ...
        'ncurses-6.0.20150627-2-i686.pkg.tar.xz',
        'libreadline-6.3.008-5-i686.pkg.tar.xz',
        'gcc-libs-4.9.2-5-i686.pkg.tar.xz',
        'gmp-6.0.0-3-i686.pkg.tar.xz',
        'bash-4.3.039-2-i686.pkg.tar.xz',
